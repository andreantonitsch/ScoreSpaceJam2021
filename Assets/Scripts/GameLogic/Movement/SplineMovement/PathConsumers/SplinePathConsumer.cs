...
public class SplinePathConsumer : PathConsumer
{

    public List<Vector2> knot_points;
    public List<Vector2> path_points;

    public int PointsPerSegment = 14;
    ...
    public void ProcessPath(List<Vector2> knots)
    {
        ...
        knot_points = knots;
        var spline = new CatMullSplineV2();
        spline.knots = knots;
        spline.PointsPerSegment = PointsPerSegment;

        PathPoints = spline.ListChain();
